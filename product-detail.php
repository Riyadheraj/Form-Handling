...
?>
	...
	<?php
	if(isset($_GET['id'])){
		$fetctproduct = mysqli_query($con, "SELECT * FROM add_product WHERE p_id = '".$_GET['id']."'");

		$data = mysqli_fetch_assoc($fetctproduct);
		?>
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="image/<?php echo $data['p_image'];?>">
									<div class="wrap-pic-w pos-relative">
										<img src="image/<?php echo $data['p_image'];?>" alt="IMG-PRODUCT">
